    ...
    <article className="mx-auto max-w-3xl space-y-8">
      ...
      <section className="rounded-2xl border border-gray-200 bg-gray-50 p-5 text-sm text-gray-700">
        ...
        <dl className="space-y-1">
          ...
          <div className="flex gap-2"><dt className="w-20 shrink-0 text-gray-500">連絡先</dt><dd><a href="tel:08058304957" className="text-brand-700 underline">080-5830-4957</a></dd></div>
        </dl>
      </section>
    </article>
  );
