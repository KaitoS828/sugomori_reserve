...
const ja: Dict = {
  ...
  form: {
    ...
    receiptNameHint: "空欄の場合はご予約者名（様付き）で発行します。「様」「御中」など敬称も含めてご記入ください。",
...
const en: Dict = {
  ...
  form: {
    ...
    receiptNameHint: "Leave blank to issue the receipt under the guest's name. If you enter a name, please include any honorific (e.g. \"Mr.\", \"Inc.\") yourself.",
